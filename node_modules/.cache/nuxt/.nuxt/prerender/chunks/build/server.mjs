...
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "cases-slug",
    path: "/cases/:slug()",
    component: () => import('./_slug_-BvCXAejd.mjs')
  },
  {
    name: "cases",
    path: "/cases",
    component: () => import('./index-C-JrocFv.mjs')
  },
  {
    name: "obrigado",
    path: "/obrigado",
    component: () => import('./obrigado-COCRLzBI.mjs')
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import('./sobre-BMsRoyae.mjs')
  },
  {
    name: "solucoes",
    path: "/solucoes",
    component: () => import('./solucoes-BXG8jTDf.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BOGpM9CZ.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DkOpm7gI.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-3xGWXyMq.mjs'));
