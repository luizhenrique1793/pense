import { s as site, _ as __nuxt_component_0, a as __nuxt_component_3 } from "./site-CIZpK5Pm.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><section class="project-page-meta" aria-label="Escopo do projeto"><div class="container"><span>Escopo do projeto</span><ul><!--[-->`);
      ssrRenderList(unref(project).services, (service) => {
        _push(`<li>${ssrInterpolate(service)}</li>`);
      });
      _push(`<!--]--></ul></div></section><section class="project-page-gallery" aria-label="Imagens do projeto"><div class="container"><!--[-->`);
      ssrRenderList(unref(project).images, (image, index) => {
        _push(`<figure class="${ssrRenderClass({ featured: index === 0 })}"><img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", `${unref(project).title} — aplicação ${index + 1}`)}${ssrRenderAttr("loading", index === 0 ? "eager" : "lazy")} decoding="async"><figcaption>Aplicação ${ssrInterpolate(String(index + 1).padStart(2, "0"))}</figcaption></figure>`);
      });
      _push(`<!--]--></div></section><section class="related-cases" aria-labelledby="related-cases-title"><div class="container"><div class="section-head"><span class="section-index">Outros cases</span><h2 id="related-cases-title">Veja também</h2></div><div class="related-grid"><!--[-->`);
      ssrRenderList(unref(relatedCases), (tile) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img${ssrRenderAttr("src", tile.image)}${ssrRenderAttr("alt", tile.alt)} loading="lazy" decoding="async"${_scopeId}><strong${_scopeId}>${ssrInterpolate(tile.title)}</strong>`);
            } else {
              return [
                createVNode("img", {
                  src: tile.image,
      ...
      _push(`<!--]--></div></div></section><section class="page-cta" aria-labelledby="case-cta-title"><div class="container"><h2 id="case-cta-title">Vamos trabalhar juntos?</h2><p>Se sua marca também precisa transformar estratégia em comunicação, a gente pode pensar junto.</p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=_slug_-BvCXAejd.js.map
