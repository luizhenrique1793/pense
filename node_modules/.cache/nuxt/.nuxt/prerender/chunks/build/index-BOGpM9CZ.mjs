import { s as site, _ as __nuxt_component_0, a as __nuxt_component_3 } from './site-CIZpK5Pm.mjs';
import { defineComponent, ref, computed, withCtx, unref, createVNode, createTextVNode, withModifiers, withDirectives, isRef, vModelText, toDisplayString, mergeProps, watch, useSSRContext } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/vue/index.mjs';
...
import { u as useSeoMeta, a as useHead } from './composables-CNVTJqCC.mjs';
  ...
  setup(__props, { emit: __emit }) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(caseTiles), (tile) => {
        _push(`<button class="case-tile" type="button"><img${ssrRenderAttr("src", tile.image)}${ssrRenderAttr("alt", tile.alt)} loading="lazy" decoding="async"><span class="case-overlay"><strong>${ssrInterpolate(tile.title)}</strong><small>${ssrInterpolate(tile.summary)}</small><i>Ver projeto →</i></span></button>`);
      });
      _push(`<!--]--></div>`);
    };
  }
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.project) {
          ...
          ssrRenderList(__props.project.images, (image, index) => {
            _push2(`<figure class="${ssrRenderClass({ featured: index === 0 })}"><img${ssrRenderAttr("src", image)}${ssrRenderAttr("alt", `${__props.project.title} — aplicação ${index + 1}`)}${ssrRenderAttr("loading", index === 0 ? "eager" : "lazy")} decoding="async"><figcaption>Aplicação ${ssrInterpolate(String(index + 1).padStart(2, "0"))}</figcaption></figure>`);
          });
...
${attribution.join("\n")}` : message;
    ...
    function goToThanks(source) {
      const query = { origem: source };
    ...
    function formatPhone(value) {
      ...
      return digits.length > 7 ? `(${digits.slice(0, 2)}) ${digits.slice(2, 7)}-${digits.slice(7)}` : digits.length > 2 ? `(${digits.slice(0, 2)}) ${digits.slice(2)}` : digits;
    }
    function maskPhone() {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_SiteHeader, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="hero-inner container"${_scopeId}><div class="hero-copy"${_scopeId}><span class="eyebrow"${_scopeId}>Estratégia que movimenta marcas</span><h1${_scopeId}>Comunicação <strong${_scopeId}>360°</strong></h1><p class="hero-services"${_scopeId}>Marketing <b${_scopeId}>•</b> Branding <b${_scopeId}>•</b> Audiovisual <b${_scopeId}>•</b> Mídia</p><p class="hero-description"${_scopeId}>Pensamos em estratégias, criamos campanhas, desenvolvemos conteúdos e conectamos marcas ao seu público-alvo.</p></div><form class="budget-form" aria-label="Solicite um orçamento"${_scopeId}><div class="form-heading"${_scopeId}><span${_scopeId}>Solicite um<br${_scopeId}>orçamento</span><i${_scopeId}></i></div><label${_scopeId}><span${_scopeId}>Nome</span><input${ssrRenderAttr("value", unref(budgetName))} name="nome" type="text" placeholder="Como podemos te chamar?" autocomplete="name" required${_scopeId}></label><label${_scopeId}><span${_scopeId}>Empresa</span><input${ssrRenderAttr("value", unref(budgetCompany))} name="empresa" type="text" placeholder="Qual é a sua empresa?" autocomplete="organization" required${_scopeId}></label><label${_scopeId}><span${_scopeId}>WhatsApp</span><input${ssrRenderAttr("value", unref(whatsapp))} name="whatsapp" type="tel" placeholder="(00) 00000-0000" autocomplete="tel" required${_scopeId}></label><button type="submit"${_scopeId}>Enviar no WhatsApp <span${_scopeId}>→</span></button><p class="${ssrRenderClass([{ visible: unref(sent) }, "form-status"])}" role="status"${_scopeId}>${ssrInterpolate(unref(sent) ? "Abrimos o WhatsApp com sua mensagem pronta para envio." : "")}</p></form></div><a class="scroll-cue" href="#cases"${_scopeId}><span${_scopeId}>Role para descobrir</span><i${_scopeId}></i></a>`);
          } else {
            return [
              createVNode("div", { class: "hero-inner container" }, [
                ...
                createVNode("form", {
                  ...
                  onSubmit: withModifiers(submitBudgetForm, ["prevent"])
                }, [
                  ...
                  createVNode("label", null, [
                    ...
                    withDirectives(createVNode("input", {
                      "onUpdate:modelValue": ($event) => isRef(budgetName) ? budgetName.value = $event : null,
                      name: "nome",
                      type: "text",
                      ...
                      [vModelText, unref(budgetName)]
                    ])
                  ]),
                  createVNode("label", null, [
                    createVNode("span", null, "Empresa"),
                    withDirectives(createVNode("input", {
                      "onUpdate:modelValue": ($event) => isRef(budgetCompany) ? budgetCompany.value = $event : null,
                      name: "empresa",
                      type: "text",
                      ...
                      [vModelText, unref(budgetCompany)]
                    ])
                  ]),
                  createVNode("label", null, [
                  ...
                  createVNode("button", { type: "submit" }, [
                    createTextVNode("Enviar no WhatsApp "),
                    createVNode("span", null, "→")
                  ]),
                  createVNode("p", {
                    class: ["form-status", { visible: unref(sent) }],
                    role: "status"
                  }, toDisplayString(unref(sent) ? "Abrimos o WhatsApp com sua mensagem pronta para envio." : ""), 3)
                ], 32)
              ]),
              createVNode("a", {
                class: "scroll-cue",
      ...
      _push(`<main><section id="cases" class="cases section" aria-labelledby="cases-title"><h2 id="cases-title" class="cases-title">Conheça alguns de nossos cases</h2>`);
      _push(ssrRenderComponent(_component_CaseGrid, {
        onOpen: ($event) => selectedProject.value = $event
      }, null, _parent));
      _push(`<div class="center-link">`);
      ...
      _push(`</div></section><section id="sobre" class="about" aria-labelledby="home-about-title"><div class="about-inner container"><span class="section-index section-index--light">02 / Sobre</span><div><h2 id="home-about-title">Somos especialistas<br>em <em>comunicação.</em></h2><p>Atuamos de forma integrada. Unimos estratégias de marketing digital com expertise em publicidade, design e inovação em produção de vídeos e fotografia. Sua comunicação inteira, pensando junto.</p>`);
      ...
      _push(`</div></div></section><section class="showreel" aria-label="Showreel Pense Assim"><div class="showreel-content"><span>Ideias precisam<br>ser <em>sentidas.</em></span><button type="button" class="play-button" aria-label="Reproduzir showreel"><svg viewBox="0 0 80 80" aria-hidden="true"><circle cx="40" cy="40" r="39"></circle><path d="m33 27 22 13-22 13Z"></path></svg></button></div></section><section id="solucoes" class="solutions section" aria-labelledby="home-solutions-title"><div class="container solutions-layout"><div class="solutions-intro"><span class="section-index">03 / Soluções</span><h2 id="home-solutions-title">Estratégia sem<br>execução é só<br><em>uma boa ideia.</em></h2></div><div class="solution-list"><!--[-->`);
      ssrRenderList([
      ...
      _push(`</div></div></section><section id="contato" class="analysis" aria-labelledby="analysis-title"><div class="container analysis-layout"><div class="analysis-copy"><span class="section-index section-index--light">04 / Vamos conversar</span><h2 id="analysis-title">Solicite uma análise<br>de sua <em>comunicação.</em></h2><p>Descubra em que caminho sua empresa está. Realizamos um diagnóstico inicial, sem compromisso.</p></div><form class="analysis-form" aria-label="Solicitar análise de comunicação"><div class="analysis-form-head"><span>Diagnóstico rápido</span><strong>Receba o retorno pelo WhatsApp</strong></div><label><span>Nome</span><input${ssrRenderAttr("value", unref(analysisName))} name="nome" autocomplete="name" required></label><label><span>Empresa</span><input${ssrRenderAttr("value", unref(analysisCompany))} name="empresa" autocomplete="organization" required></label><label class="full"><span>WhatsApp</span><input${ssrRenderAttr("value", unref(analysisWhatsapp))} name="whatsapp" type="tel" placeholder="(00) 00000-0000" autocomplete="tel" required></label><button type="submit">Enviar no WhatsApp <span>→</span></button><p class="${ssrRenderClass([{ visible: unref(analysisSent) }, "form-status"])}" role="status">${ssrInterpolate(unref(analysisSent) ? "Abrimos o WhatsApp com sua mensagem pronta para envio." : "")}</p></form></div></section><section class="clients" aria-label="Alguns de nossos clientes"><div class="client-strip"><button type="button" aria-label="Clientes anteriores">‹</button><div class="logo-row"><img${ssrRenderAttr("src", _imports_0)} alt="Silomax" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_1)} alt="Intermidia" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_2)} alt="Café Jandaia" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_3)} alt="Casa Grande" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_4)} alt="Escritório Ipiranga" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_5)} alt="Punta del Este" loading="lazy" decoding="async"></div><button type="button" aria-label="Próximos clientes">›</button></div></section><section id="insights" class="testimonials" aria-label="Fala cliente"><div class="testimonial-grid"><img${ssrRenderAttr("src", _imports_6)} alt="Depoimento de Wesley Carneiro" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_7)} alt="Depoimento de Gabriela Sanches" loading="lazy" decoding="async"><img${ssrRenderAttr("src", _imports_8)} alt="Depoimento de André Garcia" loading="lazy" decoding="async"></div></section></main>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(showVideo)) {
          _push2(`<div class="video-modal" role="dialog" aria-modal="true" aria-label="Showreel Pense Assim"><div class="video-modal-panel"><button type="button" class="video-modal-close" aria-label="Fechar vídeo">×</button><iframe${ssrRenderAttr("src", youtubeEmbedUrl)} title="Showreel Pense Assim" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      _push(`<a class="floating-whatsapp"${ssrRenderAttr("href", unref(floatingWhatsappUrl))} target="_blank" rel="noopener" aria-label="Conversar pelo WhatsApp"><span>WhatsApp</span><i>→</i></a></div>`);
    };
  }
});
...
//# sourceMappingURL=index-BOGpM9CZ.mjs.map
