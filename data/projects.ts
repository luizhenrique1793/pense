...
const path = (name: string) => `/imagens/cases/${encodeURIComponent(name)}`
...
export const caseTiles: CaseTile[] = [
...
export const projectRoutes = Object.keys(projects).map(id => `/cases/${id}`)
