...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrInterpolate, ssrRenderSlot } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button class="${ssrRenderClass([{ open: unref(open) }, "menu-toggle"])}" type="button"${ssrRenderAttr("aria-expanded", unref(open))} aria-controls="main-menu"><span></span><span></span><span></span><span class="sr-only">${ssrInterpolate(unref(open) ? "Fechar menu" : "Abrir menu")}</span></button><div id="main-menu" class="${ssrRenderClass([{ open: unref(open) }, "nav-links"])}"><span class="mobile-menu-label">Menu</span>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/cases",
      ...
      _push(`</div>`);
      if (unref(open)) {
        _push(`<button class="menu-backdrop" type="button" aria-label="Fechar menu"></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(ssrRenderComponent(_component_NuxtLink, {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))}><div class="container footer-main"><div class="footer-about"><h2>Pense Assim</h2><p>Transformamos conteúdo em design, fotografia, vídeo, publicidade e comunicação de resultados. Pensamos o seu negócio para que seus potenciais clientes lembrem da sua marca nas decisões de consumo.</p><div class="social-links" aria-label="Redes sociais"><a href="#" aria-label="Facebook">f</a><a href="#" aria-label="YouTube">▶</a><a href="#" aria-label="LinkedIn">in</a></div></div><nav class="footer-links" aria-label="Links do rodapé"><h2>Navegação</h2>`);
...
const site = {
  name: "Pense Assim",
  url: "https://www.penseassim.com.br",
  description: "Comunicação 360°, branding, marketing, audiovisual e mídia para marcas que querem crescer com estratégia.",
  phone: "+55 43 99161-9048",
  email: "fabio@penseassim.com.br"
};

export { __nuxt_component_0 as _, __nuxt_component_3 as a, site as s };
//# sourceMappingURL=site-CIZpK5Pm.mjs.map
