...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main><section class="service-showcase" aria-label="Soluções de comunicação"><!--[-->`);
      ssrRenderList(services, (service) => {
        _push(`<article class="service-row"><div class="service-copy"><h2>${ssrInterpolate(service[0])}</h2><i aria-hidden="true"></i><p>${ssrInterpolate(service[1])}</p></div><div class="${ssrRenderClass([`service-visual--${service[2]}`, "service-visual"])}" role="img"${ssrRenderAttr("aria-label", service[0])}></div></article>`);
      });
      _push(`<!--]--></section><section class="page-cta" aria-labelledby="solutions-cta-title"><div class="container"><h2 id="solutions-cta-title">Somos especialistas<br>em comunicação</h2><p>Nosso time combina pensamento estratégico e execução para que cada canal conte a mesma história — e movimente o mesmo resultado.</p>`);
...
//# sourceMappingURL=solucoes-BXG8jTDf.js.map
