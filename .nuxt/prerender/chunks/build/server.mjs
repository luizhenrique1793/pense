import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, ref, h, Suspense, Fragment, createApp, provide, shallowReactive, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, shallowRef, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/unctx/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/vue/server-renderer/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file://C:/Users/conta/OneDrive/Documentos/GitHub/pense/node_modules/h3/dist/index.mjs';
...
const _routes = [
  {
    name: "cases-slug",
    path: "/cases/:slug()",
    component: () => import('./_slug_-BVmZ1lA6.mjs')
  },
  {
    name: "sobre",
    path: "/sobre",
    component: () => import('./sobre-B2-t2pnJ.mjs')
  },
  {
    name: "solucoes",
    path: "/solucoes",
    component: () => import('./solucoes-D4FUB3He.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-D22rWAOI.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DBZXccC2.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CK7a7gQZ.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, createError as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useRoute as u };
